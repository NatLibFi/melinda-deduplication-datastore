...
ALTER TABLE record DROP timestamp, DROP recordTimestamp;
ALTER TABLE delta CHANGE timestamp DATETIME NOT NULL, ADD type ENUM('CONTENT', 'METADATA', 'CONTENT_AND_METADATA'), DROP INDEX base_id, ADD PRIMARY KEY (base, id, timestamp, type);